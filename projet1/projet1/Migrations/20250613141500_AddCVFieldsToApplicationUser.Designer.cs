...
namespace projet1.Migrations
{
    ...
    [Migration("20250613141500_AddCVFieldsToApplicationUser")]
    partial class AddCVFieldsToApplicationUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("projet1.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("projet1.Data.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("projet1.Data.Models.CoachSubscription", b =>
                {
                    ...
                    b.HasOne("projet1.Data.Models.SubscriptionPlan", "SubscriptionPlan")
                        .WithMany()
            ...
            modelBuilder.Entity("projet1.Data.Models.SubscriptionPlan", b =>
                {
                    b.HasOne("projet1.Data.Models.ApplicationUser", "Coach")
                        .WithMany()
